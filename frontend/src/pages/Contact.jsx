...
const Contact = () => {
  ...
  const getContactInfo = () => {
    ...
    const contacts = {
      en: {
        phone: '+66 610 089 377',
        email: 'info@novaestate.company',
              ...
              <div className="space-y-6 mb-8">
                {contactInfo.map((item, index) => (
                  <div key={index} className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 bg-blue-500/10 text-blue-500 
                    ...
                    <div>
                      ...
                      {item.link ? (
                        ...
                        >
                          <span dir={item.isLtr ? 'ltr' : undefined} className={item.isLtr ? 'inline-block' : ''}>
                            {item.content}
                          </span>
                        </a>
                      ) : (
