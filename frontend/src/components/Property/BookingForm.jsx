...
const BookingForm = ({ property, selectedDates = null, isOpen, onClose }) => {
  ...
  const getContacts = () => {
    const contacts = {
      ru: {
        telegram: { url: 'https://t.me/novaestate_manager', label: '@novaestate_manager' },
        whatsapp: { url: 'https://wa.me/66610089377', label: '+66 610 089 377' },
        email: { url: 'mailto:info@novaestate.company', label: 'info@novaestate.company' },
        phone: { url: 'tel:+66610089377', label: '+66 610 089 377' }
      },
      en: {
        telegram: { url: 'https://t.me/novaestate_manager', label: '@novaestate_manager' },
        whatsapp: { url: 'https://wa.me/66610089377', label: '+66 610 089 377' },
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="font-medium text-gray-900 dark:text-white truncate text-sm">
                          <span dir="ltr" className="inline-block">{contacts.telegram.label}</span>
                        </div>
                      </div>
                    </a>
                    ...
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-xl hover:bg-green-100 dark:hover:bg-green-900/30 transition-all group"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="font-medium text-gray-900 dark:text-white truncate text-sm">
                          <span dir="ltr" className="inline-block">{contacts.whatsapp.label}</span>
                        </div>
                      </div>
                    </a>
                    ...
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-all group"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="font-medium text-gray-900 dark:text-white truncate text-sm">
                          <span dir="ltr" className="inline-block">{contacts.email.label}</span>
                        </div>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="font-medium text-gray-900 dark:text-white truncate text-sm">
                          <span dir="ltr" className="inline-block">{contacts.phone.label}</span>
                        </div>
                      </div>
                    </a>
                  </div>
