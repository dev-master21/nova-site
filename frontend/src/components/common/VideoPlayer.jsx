            ...
            {showControls && !isFullscreen && (
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg">NOVA ESTATE Luxury Villas</h3>
                ...
                {showControls && (
                  ...
                  >
                    <div className="bg-black/50 backdrop-blur-sm rounded-lg px-3 py-2">
                      <span className="text-white/80 text-sm font-semibold">NOVA ESTATE VILLAS</span>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
